...
public final Sql DMS_Sql()
{
	try
	{
		String dbstring = "jdbc:jtds:sqlserver://192.168.100.67:1433/rwsDocuments";
		return(Sql.newInstance(dbstring, "rwslogin", "rwslogin", "net.sourceforge.jtds.jdbc.Driver"));
	}
	catch (Exception e)
	{
		return null;
...
// Connection conn = DriverManager.getConnection("jdbc:jtds:sqlserver://alsslws007:1433/AccDatabase1", "sa", "sa");
	try
	{
		String dbstring = "jdbc:jtds:sqlserver://192.168.100.201:1433/rwsdb2";
		//Sql thesql = new Sql();
